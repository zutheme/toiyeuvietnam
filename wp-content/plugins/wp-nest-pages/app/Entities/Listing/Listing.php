<?php 
namespace nestpages\Entities\Listing;

use nestpages\Helpers;
use nestpages\Entities\Confirmation\ConfirmationFactory;
use nestpages\Entities\Post\PostDataFactory;
	...
	private function listPostLevel($parent = 0, $count = 0, $level = 1)
	{
		...
		foreach($pages as $page) :
			...
			if ( $this->post->status !== 'trash' ) :
				...
				$filtered_sortable = apply_filters('nestpages_post_sortable', true, $this->post, $this->post_type);
