...
class PostTypeCustomFields 
{
	...
	{
		$fields = apply_filters('nestpages_quickedit_custom_fields', [], $post_type, $column);
	...
	*/
	...
	{
		$custom_fields_left = apply_filters('nestpages_quickedit_custom_fields', [], $post_type, $column = 'left');
		$custom_fields_right = apply_filters('nestpages_quickedit_custom_fields', [], $post_type, $column = 'right');
