...
?>
<div class="nestpages-modal-backdrop" data-nestpages-modal="np-link-modal"></div>
<div class="nestpages-modal-content np-link-modal-content <?php if ( $this->integrations->plugins->dark_mode->installed ) echo 'np-dark-mode'; ?>" id="np-link-modal" data-nestpages-modal="np-link-modal">
		...
		<div id="npmenuitems" class="np-tabbed-content" data-np-tab-pane>
					...
					<ul data-np-menu-accordion>
						...
						<?php
							...
							foreach ( $this->listing_repo->postTypes() as $name => $type ) {
								...
								ob_start();
									include( nestpages\Helpers::asset('images/spinner.svg') );
									$out .= ob_get_contents();
								ob_end_clean();
								$out .= '</div>';
			...
			<div class="modal-footer">
				<div class="footer-inner">
					...
					<button type="button" class="button modal-close" data-nestpages-modal-close>
