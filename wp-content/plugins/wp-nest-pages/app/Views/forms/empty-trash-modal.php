...
*/
?>
<div class="nestpages-modal-backdrop" data-nestpages-modal="np-trash-modal"></div>
<div class="nestpages-modal-content small short <?php if ( $this->integrations->plugins->dark_mode->installed ) echo 'np-dark-mode'; ?>" id="np-trash-modal" data-nestpages-modal="np-trash-modal">
