		...
		<div class="right">
			...
			<div class="comments">
				<label>
					...
					<span class="checkbox-title"><?php _e( 'Hide in Nest Pages', 'wp-nested-pages' ); ?></span>
				</label>
			</div>
			...
			$sticky_available = apply_filters('nestpages_sticky_available', $sticky_available, $this->post, $this->post_type);
			$make_sticky = apply_filters('nestpages_make_sticky_text', __('Make Sticky', 'wp-nested-pages'), $this->post, $this->post_type);
			if ( $sticky_available ) : 
			?>
			<div class="comments">
				<label>
