...
*/
?>
<div class="nestpages-modal-backdrop" data-nestpages-modal="np-clone-modal"></div>
<div class="nestpages-modal-content small short <?php if ( $this->integrations->plugins->dark_mode->installed ) echo 'np-dark-mode'; ?>" id="np-clone-modal" data-nestpages-modal="np-clone-modal">
