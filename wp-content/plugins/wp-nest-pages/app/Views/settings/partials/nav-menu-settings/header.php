<div class="np-menu-customization-header">
	...
	<div class="new">
		<div class="nestpages-dropdown" data-dropdown>
			<a href="#" class="nestpages-dropdown-toggle" data-dropdown-toggle><?php _e('New', 'wp-nested-pages'); ?> <span class="np-caret"></span></a>
			<div class="nestpages-dropdown-content right" data-dropdown-content>
				<ul>
