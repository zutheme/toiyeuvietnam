<div class="nestpages-list-header">
	<div class="np-check-all">
		<input type="checkbox" data-np-check-all="nestpages_bulk[]" data-np-bulk-checkbox />
	</div>
	<form data-np-bulk-form style="display:none;" action="<?php echo admin_url('admin-post.php'); ?>" method="post" class="np-bulk-form">
		...
		<select id="np_bulk" name="np_bulk_action" class="nestpages-sort">
	...
	<p class="np-hidden-select-count" data-np-hidden-count-parent><span data-np-hidden-count></span> <?php _e('Nested Items Selected', 'wp-nested-pages'); ?>. <a href="#" class="nestpages-toggleall"><?php _e('Expand All', 'wp-nested-pages'); ?></a></p>
</div>