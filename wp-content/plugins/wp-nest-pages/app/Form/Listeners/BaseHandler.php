...
abstract class BaseHandler 
{
	...
	*/
	...
	{
		if ( ! wp_verify_nonce( $this->nonce, 'nestpages-nonce' ) ){
	...
	protected function syncMenu()
	{
		...
		if ( $_POST['post_type'] == 'page' ) {
			if ( $_POST['syncmenu'] !== 'sync' ){
				return update_option('nestpages_menusync', 'nosync');
			}
			update_option('nestpages_menusync', 'sync');
			try {
