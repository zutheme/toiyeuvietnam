<?php 
namespace nestpages\Form\Validation;

use nestpages\Config\SettingsRepository;

/**
* Nest Pages Form Validation
*/
class Validation 
{
	/**
	...
	*/
	public function validateCustomFields($data)
	{
		...
		$fields_left = apply_filters('nestpages_quickedit_custom_fields', [], $post_type, 'left');
		$fields_right = apply_filters('nestpages_quickedit_custom_fields', [], $post_type, 'right');
